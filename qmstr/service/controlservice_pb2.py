...
_PACKAGEREQUEST = _descriptor.Descriptor(
  name='PackageRequest',
  full_name='service.PackageRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='session', full_name='service.PackageRequest.session', index=0,
...
PackageRequest = _reflection.GeneratedProtocolMessageType('PackageRequest', (_message.Message,), dict(
