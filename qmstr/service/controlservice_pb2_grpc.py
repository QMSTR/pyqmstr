...
import controlservice_pb2 as controlservice__pb2
...
class ControlServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetPackageNode = channel.unary_unary(
        ...
        request_serializer=controlservice__pb2.PackageRequest.SerializeToString,
...
def add_ControlServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'GetPackageNode': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=controlservice__pb2.PackageRequest.FromString,
